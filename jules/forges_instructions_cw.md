...
**CRITICAL RULE:** This file (`jules/forges_instructions_cw.md`) must NEVER be changed again. This update is the sole exception.
...
2. **jules/ai_usage_cw.md:** Usage journal to document AI collaboration.
...
## Output Format
- [TAGS]
- AI Usage Entry (for ai_usage_cw.md)
- Architecture Plan
- Code Blocks
