...
*   **Logique de Représentation Exclusive :** Les scripts attachés aux nœuds Godot gèrent les états visuels (`Sprite2D` / `AnimationPlayer`, `_PhysicsProcess`, hitboxes). Par exemple, la logique d'un Dash ou les limites d'un "cooldown" temporel vivent ici.
